            ...
            <Card>
              <CardContent>
                <Box display="flex" flexDirection="column" alignItems="center" gap={2}>
                  <Avatar sx={{ width: 100, height: 100, bgcolor: 'primary.main' }}>{initials || <AccountCircleIcon fontSize="large" />}</Avatar>
                  ...
                  <Typography variant="body2">Joined: {new Date(managerProfile.joiningDate).toLocaleDateString()}</Typography>
                  <Typography variant="body2">Status: <Chip size="small" label={managerProfile.isActive ? 'Active' : 'Inactive'} color={managerProfile.isActive ? 'success' : 'default'} /></Typography>
                </Box>
              </CardContent>
            </Card>
          </Grid>
