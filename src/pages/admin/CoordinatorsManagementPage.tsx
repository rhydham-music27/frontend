        ...
        <Table size="small" sx={{ minWidth: 750 }}>
          <TableHead>
            <TableRow sx={{ bgcolor: 'grey.100', '& .MuiTableCell-root': { color: 'text.primary', fontWeight: 700, borderBottom: '2px solid', borderColor: 'divider' } }}>
              ...
              <TableCell sx={{ fontWeight: 700 }}><TableSortLabel active={sortBy === 'name'} direction={sortBy === 'name' ? sortOrder : 'asc'} onClick={() => handleSort('name')} >Name</TableSortLabel></TableCell>
              <TableCell sx={{ fontWeight: 700 }}>Email</TableCell>
              <TableCell sx={{ fontWeight: 700 }}>Specialization</TableCell>
              <TableCell align="right" sx={{ fontWeight: 700 }}><TableSortLabel active={sortBy === 'activeClassesCount'} direction={sortBy === 'activeClassesCount' ? sortOrder : 'asc'} onClick={() => handleSort('activeClassesCount')} >Active Classes</TableSortLabel></TableCell>
              <TableCell align="right" sx={{ fontWeight: 700 }}><TableSortLabel active={sortBy === 'totalClassesHandled'} direction={sortBy === 'totalClassesHandled' ? sortOrder : 'asc'} onClick={() => handleSort('totalClassesHandled')} >Total Classes</TableSortLabel></TableCell>
              <TableCell align="right" sx={{ fontWeight: 700 }}>Max Capacity</TableCell>
              <TableCell align="right" sx={{ fontWeight: 700 }}>Available</TableCell>
              <TableCell align="right" sx={{ fontWeight: 700 }}><TableSortLabel active={sortBy === 'performanceScore'} direction={sortBy === 'performanceScore' ? sortOrder : 'asc'} onClick={() => handleSort('performanceScore')} >Performance</TableSortLabel></TableCell>
              <TableCell sx={{ fontWeight: 700 }}><TableSortLabel active={sortBy === 'isActive'} direction={sortBy === 'isActive' ? sortOrder : 'asc'} onClick={() => handleSort('isActive')} >Status</TableSortLabel></TableCell>
